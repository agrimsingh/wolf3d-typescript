...
emcc "$ROOT_DIR/c-oracle/wolf_oracle.c" "$ROOT_DIR/c-oracle/wolfsrc_phase1_math.c" "$ROOT_DIR/c-oracle/wolfsrc_phase2_map.c" "$ROOT_DIR/c-oracle/wolfsrc_phase3_raycast.c" "$ROOT_DIR/c-oracle/wolfsrc_phase4_ai.c" \
  -O2 \
  -s MODULARIZE=1 \
  -s EXPORT_ES6=1 \
