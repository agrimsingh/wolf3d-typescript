...
describe('runtime step parity', () => {
  ...
  it('oracle runtime trace symbols are deterministic for identical scenarios', async () => {
    ...
    expect(a.includes(121)).toBe(true); // ID_VH.VWB_Plot
    expect(a.includes(122)).toBe(true); // ID_VH.VWB_Hlin
    expect(a.includes(123)).toBe(true); // ID_VH.VWB_Vlin
    expect(a.includes(124)).toBe(true); // ID_VH.VWL_MeasureString
    expect(a.includes(125)).toBe(true); // ID_VH.VWB_DrawPropString
    expect(a.includes(126)).toBe(true); // ID_VL.VL_Vlin
    expect(a.includes(127)).toBe(true); // ID_VL.VL_ScreenToScreen
    expect(a.includes(128)).toBe(true); // ID_VL.VL_MaskedToScreen
    expect(a.includes(129)).toBe(true); // ID_VL.VL_MemToLatch
    expect(a.includes(130)).toBe(true); // ID_VL.VL_ClearVideo
    expect(a.includes(131)).toBe(true); // ID_VH.VW_DrawPropString
    expect(a.includes(132)).toBe(true); // ID_VH.VW_DrawColorPropString
    expect(a.includes(133)).toBe(true); // ID_VH.VW_MeasureMPropString
    expect(a.includes(134)).toBe(true); // ID_VH.VWB_DrawTile8
    expect(a.includes(135)).toBe(true); // ID_VH.VWB_DrawTile8M
    expect(a.includes(136)).toBe(true); // ID_VL.VL_SetColor
    expect(a.includes(137)).toBe(true); // ID_VL.VL_GetColor
    expect(a.includes(138)).toBe(true); // ID_VL.VL_SetPalette
    expect(a.includes(139)).toBe(true); // ID_VL.VL_GetPalette
    expect(a.includes(140)).toBe(true); // ID_VL.VL_FillPalette
    expect(a.includes(141)).toBe(true); // ID_VH.VW_MarkUpdateBlock
    expect(a.includes(142)).toBe(true); // ID_VH.VW_UpdateScreen
    expect(a.includes(143)).toBe(true); // ID_VH.LatchDrawPic
    expect(a.includes(144)).toBe(true); // ID_VH.LoadLatchMem
    expect(a.includes(145)).toBe(true); // ID_VH.VL_MungePic
    expect(a.includes(146)).toBe(true); // ID_VL.VL_SetLineWidth
    expect(a.includes(147)).toBe(true); // ID_VL.VL_SetSplitScreen
