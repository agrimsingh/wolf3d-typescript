...
void SpawnStatic (int tilex, int tiley, int type)
{
	...
	{
	case block:
		actorat[tilex][tiley] = (objtype *)(uintptr_t)(1);		// consider it a blocking tile
	case dressing:
		laststatobj->flags = 0;
		break;
...
void PushWall (int checkx, int checky, int dir)
{
	...
	case di_north:
		...
		actorat[checkx][checky-1] = (objtype *)(uintptr_t)(tilemap[checkx][checky-1] = oldtile);
		break;
	...
	case di_east:
		...
		actorat[checkx+1][checky] = (objtype *)(uintptr_t)(tilemap[checkx+1][checky] = oldtile);
		break;
...
void MovePWalls (void)
{
	...
	// block crossed into a new block
		...
		actorat[pwallx][pwally] = (objtype *)(uintptr_t)(0);
		*(mapsegs[0]+farmapylookup[pwally]+pwallx) = player->areanumber+AREATILE;
		...
		else
		{
			...
			case di_north:
				...
				actorat[pwallx][pwally-1] = (objtype *)(uintptr_t)(tilemap[pwallx][pwally-1] = oldtile);
				break;
			...
			case di_east:
				...
				actorat[pwallx+1][pwally] = (objtype *)(uintptr_t)(tilemap[pwallx+1][pwally] = oldtile);
				break;
