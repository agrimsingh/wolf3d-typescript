...
- Supplemental presentation/audio assets: deterministic mapping from `assets/wolf3d-assets.zip` and `/assets/wolf3d-assets.zip` at runtime.
...
- [ ] Add root `README.md` with project purpose, execution history, commands, and TODO direction.
- [ ] Reset specs/TODO truth to WL6 migration baseline.
- [ ] Add `specs/wl6-modern-runtime-execution-spec.md`.
- [ ] Add docs verification script (`pnpm verify:docs`).
- [ ] Add visible baseline status label in browser app for migration track.
- [ ] Gate: `pnpm typecheck`
- [ ] Gate: `pnpm test:smoke`
- [ ] Gate: `pnpm verify:docs`
- [ ] Agent-browser check recorded
- [ ] Tests green
- [ ] Phase commit pushed (`k0: add readme and reset wl6 execution baseline`)
