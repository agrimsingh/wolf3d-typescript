...
- `generated/wolfsrc-runtime-classification.json`: full inventory classification (`required-runtime` vs `excluded-non-runtime`) generated from runtime trace evidence.
- [runtime-symbol-classification.md](./runtime-symbol-classification.md): human-readable summary of full 568-symbol classification output.
- `generated/runtime-checkpoints.json`: deterministic WL1 fixture tick/frame checkpoints generated by `pnpm runtime:checkpoints:generate`.
- `generated/runtime-checkpoints-lock.json`: frozen R5 lock consumed by `pnpm runtime:checkpoints:verify`.
- `generated/runtime-episode-checkpoints.json`: deterministic all-map WL1 episode checkpoint artifact generated by `pnpm runtime:episode:generate`.
- `generated/runtime-episode-checkpoints-lock.json`: frozen R7 lock consumed by `pnpm runtime:episode:verify`.
- Runtime parity harness implementation: `src/runtime/parityHarness.ts` and runtime repro tooling in `scripts/runtime/`.
- Runtime core guard script: `scripts/runtime/verify-runtime-core-guard.sh`.
